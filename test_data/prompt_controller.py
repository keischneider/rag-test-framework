...
Use the following knowledge base to inform your test case generation:
{knowledge_base}

Characteristics of a bank customer, from the standpoint from which the questions are generated: {persona_characteristics}
...
def get_testdata_prompt_template(knowledge_base, persona_characteristics, scenarios, example_format, num_cases=5):
